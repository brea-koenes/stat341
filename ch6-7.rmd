...
a and c are 100% acceptance probability. We would certainly want to accept the proposed location in these scenarios becaused the proposed plausability is better than the current plausibility. This means the proposed value makes a better posterior than the current one.
